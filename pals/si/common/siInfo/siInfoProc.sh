...
typeset RcsId="$Id: srInfoProc.sh,v 1.1 2015-04-28 19:49:53 lsipusr Exp $"
# *CopyLeft*
...
$( examplesSeperatorChapter "File Parameters Write/Read" )
$( examplesSeperatorSection "File Parameters Write" )
fileParamManage.py -i fileParamWritePath ./srFqdn git.bysource.org
$( examplesSeperatorSection "File Parameters Read" )
fileParamManage.py -i fileParamReadPath ./srFqdn
_EOF_
}
...
_EOF_
    ...
    lpDo fileParamManage.py -i fileParamWritePath ./svcFqdn paramValue
    EH_retOnFail
