...
*      Smtp Submit   ::  [[elisp:(set-smtp 'smtp "mail.t-mobile.com" 25 nil nil)][mail.t-mobile.com]]  [[elisp:(progn (server-start) (lsip-local-run-command "cd /acct/employee/lsipusr/BUE/mailings/com/t-mobile; mailingProc.sh -i treeRecurse objectAutoLoad"))][(Start Initialize)]] [[elisp:(find-file "/acct/employee/lsipusr/BUE/mailings/com/t-mobile")][(Edit)]] NOTYET-Visit "*trace of SMTP Session*" 
*      ================
