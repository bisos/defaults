...
typeset RcsId="$Id: lcaXxSysvAdmin.sh,v 1.1 2020-08-24 05:05:20 lsipusr Exp $"
# *CopyLeft*
...
**  [[elisp:(org-cycle)][| ]]  Subject      :: [[file:/libre/ByStar/InitialTemplates/activeDocs/bxPlatformFacilities/git-daemon/fullUsagePanel-en.org::Xref-BxPlatformFacilities-Celery-Daemon][Panel Roadmap Documentation]] [[elisp:(org-cycle)][| ]]
