...
"
FILE="
*  /This File/ :: /bisos/apps/defaults/software/begin/iimBash/binsPrepExtRepo.sh 
"
if [ "${loadFiles}" == "" ] ; then
...
Xref-
**  [[elisp:(org-cycle)][| ]]  Panel        :: [[file:/bisos/apps/defaults/activeDocs/bxPlatform/baseDirs/samba/fullUsagePanel-en.org::Xref-][MODULE Panel]] [[elisp:(org-cycle)][| ]]
